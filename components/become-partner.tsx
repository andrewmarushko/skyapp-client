...
export const BecomePartner: FunctionComponent<BecomePartnerPropsInterface> = ({ data }) => {
  ...
  return (
    <div className='p-8 lg:p-16 rounded-2xl font-bold border border-accent-200 bg-accent-100 text-accent-900 w-full flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-0'>
